      ...
      >
        ...
        <View style={styles.coverContainer}>
          {service.thumbnail ? (
            ...
            >
              <Ionicons name="briefcase-outline" size={40} color="rgba(255,255,255,0.3)" />
            </LinearGradient>
          )}
          ...
          <View style={styles.ratingBadge}>
            ...
            <Text style={styles.ratingText}>{rating.averageRating.toFixed(1)}</Text>
          </View>
        ...
        <View style={styles.content}>
          <View style={styles.providerRow}>
            ...
            <View style={styles.avatarContainer}>
              <Image
                source={{ uri: `https://i.pravatar.cc/150?u=${service.providerId}` }}
                style={styles.avatar}
              />
            </View>
            <View style={styles.providerInfo}>
              ...
              <View style={styles.locationRow}>
                <Ionicons name="location-outline" size={12} color={TOKENS.color.sub} />
          ...
          <View style={styles.serviceDetails}>
            ...
            <Text style={styles.reviewsText}>{rating.reviewsCount} reseñas</Text>
          </View>

          <View style={styles.footer}>
            <Text style={styles.ctaText}>Ver detalles</Text>
            <Ionicons name="arrow-forward" size={16} color={Colors.colorPrimary} />
          </View>
        </View>
      </Pressable>
    </MotiView>
