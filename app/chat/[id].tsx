...
export default function ChatDetailScreen() {
    ...
    const { loadChatMessages, sendNewMessage, currentChatMessages, chats } = useChat();

    // Find current chat info from cached chats list for header info
    const chatInfo = chats.find(c => c.id === id);
    const participant = chatInfo?.participants[0] || { name: 'Unknown User', avatar: 'https://i.pravatar.cc/150' };
